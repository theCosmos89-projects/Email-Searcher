...
Class MailExtractor
    ...
    Private Shared Function RegexString() As String
        ...
        RegexString = $"\b(?!\d+(\.\d+)*@)\w{v1}([-+.]\w{v1})*@\w{v1}([-.])*\.\w{v1}([-.]\w{v1})*"
    ...
    Private Shared Function GetDomainExtensions() As HashSet(Of String)
        Dim domainList As New HashSet(Of String)(
    My.Resources.domains.Split({ControlChars.CrLf, ControlChars.Lf, ControlChars.Cr},
